...
public class Home extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        Log.d("Step Counter", "Loaded daily steps");
        Set<String> keySet = dailySteps.keySet();
        for (String key : keySet) {
            Log.d("Step Counter", dailySteps.get(key));
        }
        List<String> dateList = new ArrayList<>(keySet);
...
//            String dateKey = dateFormat.format(calendar.getTime());
            String stepsInfo = dailySteps.getOrDefault(dateKey, "0/1000");
            ...
            rowLayout.setPadding(100,4,100,4);
            if (i % 2 == 0) {
                rowLayout.setGravity(Gravity.START | Gravity.CENTER_VERTICAL);
            } else {
                rowLayout.setGravity(Gravity.END | Gravity.CENTER_VERTICAL);
            }
